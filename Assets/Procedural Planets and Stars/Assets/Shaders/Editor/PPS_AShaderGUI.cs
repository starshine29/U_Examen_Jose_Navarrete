...
public abstract class PPS_AShaderGUI : ShaderGUI
{
    ...
    protected void DoAnimationPart(Material _targetMat, MaterialEditor _editor, MaterialProperty[] _properties, out bool _toggle)
    {
        ShowToggle(_targetMat, _editor, out _toggle, "Animate", "_ANIMATE_ON", "");
        if (_toggle)
        {
            EditorGUI.indentLevel++;
            ShowShaderProperty(_editor, _properties, "Speed", "_AnimationSpeed", "");
            EditorGUI.indentLevel--;
        }
    }
}
